   ...
   public function getNotificationDetails($orderID)
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($result) {
            ...
            $oldPrderProducts = OrderProducts::onlyTrashed()->where('order_id', $order->id)->get();
            foreach ($oldPrderProducts as $op) {
                $op->forceDelete();
            }
            foreach ($products as $product) {
                $orderProducts  = new OrderProducts();
    ...
    public function oldOrders(Request $request)
    {
        ...
        if ($customer) {
            ...
            $order['data'] = $orders->map(function ($order) {
                ...
                // Use implode to create the product string
            ...
            $order['data'] = []; // or any appropriate response
        }
