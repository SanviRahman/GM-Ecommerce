...
class ProductController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        return DataTables::of(Product::with('media','categories')->orderBy('id','desc')->get())
            ...
            ->addColumn('action', function ($product) {
                return "
                <a href='".route('manager.product.option-price', $product->id)."' class='action-icon btn-edit'> <i class='fas fa-1x fa-tags'></i></a>
    ...
    public function productOptionPrice($id)
    {
        ...
        return view('manager.product.option', compact('product','options'));
    }
    public function updateOptionPrice(Request $request, $id)
    {
        ...
        return redirect()->route('manager.product.option-price', $id)
