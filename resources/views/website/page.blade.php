...
@section('content')
                ...
                @foreach($relatedProducts as $product)
                    <div class="col-md-3 col-6">
                        <div href="#" class="card card-product-grid product-box-2">
                            ...
                            <button class="btn btn-dark btn-sm btn-block" onclick="addToCart({{ $product->id }})">
    ...
    window.dataLayer.push({
        event: "page_view",
        page: {
            title: "{{ $page->pageTitle }}",  // Dynamic Page Title
    ...
    <script>
    fbq('track', 'PageView', {
        page_title: "{{ $page->pageTitle }}", // Dynamic Page Title
        page_url: "{{ url()->current() }}" // Current URL
    });
    </script>
