        ...
        <div id="sidebar-menu">
            @if(Auth::check() && Auth::user()->role->id == 1)
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li class="{{ (request()->is('admin/option')) ? 'active' : '' }}">
                            <a href="{{ url('admin/option') }}" class="{{ (request()->is('admin/option')) ? 'active' : '' }}">Option</a>
                        </li>
                        <li class="{{ (request()->is('admin/size')) ? 'active' : '' }}">
                            <a href="{{ url('admin/size') }}" class="{{ (request()->is('admin/size')) ? 'active' : '' }}">Size</a>
                        </li>
                        <li class="{{ (request()->is('admin/color')) ? 'active' : '' }}">
                            <a href="{{ url('admin/color') }}" class="{{ (request()->is('admin/color')) ? 'active' : '' }}">Color</a>
                        </li>
                        
                        <li class="{{ (request()->is('admin/section')) ? 'active' : '' }}">
                            <a href="{{url('admin/section ')}}" class="{{ (request()->is('admin/section')) ? 'active' : '' }}">Section</a>
                        </li>
                        ...
                        <li class="{{ (request()->is('admin/campaign')) ? 'active' : '' }}">
                            <a href="{{url('admin/campaign ')}}" class="{{ (request()->is('admin/campaign')) ? 'active' : '' }}">Campaign</a>
                        </li>
                ...
                <li class="{{ (request()->routeIs('admin/order')) ? 'active' : '' }}">
                    <a href="{{url('admin/order/status/Incomplete ')}}" class="{{ (request()->is('admin/order')) ? 'active' : '' }}">
                ...
                <li class="{{ (request()->is('admin/ip')) ? 'active' : '' }}">
                    <a href="{{url('admin/ip ')}}" class="{{ (request()->is('admin/ip')) ? 'active' : '' }}">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav-second-level" aria-expanded="false">
                                ...
                                <li class="{{ (request()->is('manager/category')) ? 'active' : '' }}">
                                    <a href="{{url('manager/category ')}}" class="{{ (request()->is('manager/category')) ? 'active' : '' }}">Category</a>
                                </li>
                                <li class="{{ (request()->is('manager/option')) ? 'active' : '' }}">
                                    <a href="{{ url('manager/option') }}" class="{{ (request()->is('manager/option')) ? 'active' : '' }}">Option</a>
                                </li>
                                <li class="{{ (request()->is('manager/size')) ? 'active' : '' }}">
                                    <a href="{{ url('manager/size') }}" class="{{ (request()->is('manager/size')) ? 'active' : '' }}">Size</a>
                                </li>
                                <li class="{{ (request()->is('manager/color')) ? 'active' : '' }}">
                                    <a href="{{ url('manager/color') }}" class="{{ (request()->is('manager/color')) ? 'active' : '' }}">Color</a>
                                </li>
                                
                                <li class="{{ (request()->is('manager/section')) ? 'active' : '' }}">
                                    <a href="{{url('manager/section ')}}" class="{{ (request()->is('manager/section')) ? 'active' : '' }}">Section</a>
                                </li>
                        ...
                        <li class="{{ (request()->routeIs('manager/order')) ? 'active' : '' }}">
                            <a href="{{url('manager/order/status/Incomplete ')}}" class="{{ (request()->is('manager/order')) ? 'active' : '' }}">
                                <i class="fe-alert-circle"></i>
                                <span>Incomplete Order </span>
                            </a>
                        </li>
                        ...
                        <!--<li class="{{ (request()->is('manager/ip')) ? 'active' : '' }}">-->
                        <!--    <a href="{{url('manager/ip ')}}" class="{{ (request()->is('manager/ip')) ? 'active' : '' }}">-->
                        <!--        <i class="fas fa-bars"></i>-->
                        <!--        <span> IP Manage </span>-->
                        <!--    </a>-->
                        <!--</li>-->
                        <li class="{{ (request()->is('manager/optimize')) ? 'active' : '' }}">
                            <a href="{{url('manager/optimize ')}}" class="{{ (request()->is('manager/optimize')) ? 'active' : '' }}">
                                <i class="far fa-trash-alt"></i>
                                <span>Optimize</span>
                            </a>
                        </li>
            ...
            @if(Auth::check() && Auth::user()->role->id == 3 )
                <ul class="metismenu" id="side-menu">
                    ...
                    <li class="{{ (request()->routeIs('user/order')) ? 'active' : '' }}">
                        <a href="{{url('user/order/status/Incomplete ')}}" class="{{ (request()->is('user/order')) ? 'active' : '' }}">
                            <i class="fe-alert-circle"></i>
                            <span>Incomplete Order </span>
                        </a>
                    </li>
