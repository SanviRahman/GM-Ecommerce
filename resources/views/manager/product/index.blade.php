                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group mb-3">
                                <label for="productColor">Color <span class="text-danger">*</span></label>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#productSize").select2({
                ...
                ajax: {
                    type: "post",
                    url: '{{url('manager/product/size')}}', // Update this URL as needed
                    data: {
                        '_token': token
                    },
                    processResults: function (data) {
            ...
            $("#productColor").select2({
                ...
                ajax: {
                    type: "post",
                    url: '{{url('manager/product/color')}}', // Update this URL as needed
                    data: {
                        '_token': token
                    },
                    processResults: function (data) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#productSize").select2({
                            ...
                            ajax: {
                                type: "post",
                                url: '{{url('manager/product/size')}}', // Update this URL if necessary
                                data: {
                                    '_token': token
                                },
                                processResults: function (data) {
                        ...
                        $("#productColor").select2({
                            ...
                            ajax: {
                                type: "post",
                                url: '{{url('manager/product/color')}}', // Update this URL if necessary
                                data: {
                                    '_token': token
                                },
                                processResults: function (data) {
