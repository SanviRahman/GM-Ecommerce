                        ...
                        <div class="col-md-8">
                            <div class="text-md-right">
                                ...
                                <select class="btn btn-danger btn-xs waves-effect waves-light mr-2 float-right" id="importSelect">
                                    ...
                                    <option value="steadfast">API Steadfast Import</option>
                                    <option value="pathao">API Pathao Import</option>
...
@push('js')
    ...
    dateFormat: "Y-m-d h:i K", // Format for the output value (12-hour format with AM/PM)
