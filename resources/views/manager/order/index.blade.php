            ...
            <a href="{{ url('manager/order/status/Canceled')}}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
                                <h3 class="text-danger mt-1 mb-0">
                                    <span id="canceled" data-plugin="counterup">0</span>
                                </h3>
                                <p class="text-danger mb-1 text-truncate">Canceled</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </div> <!-- end widget-rounded-circle-->
            ...
            <a href="{{ url('manager/order/status/Completed')}}">
                ...
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
                                <h3 class="text-success mt-1 mb-0">
                                    <span id="completed" data-plugin="counterup">0</span>
                                </h3>
                                <p class="text-success mb-1 text-truncate">Completed</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </div> <!-- end widget-rounded-circle-->
                        ...
                        <div class="col-md-8">
                            <div class="text-md-right">
                                ...
                                <select class="btn btn-danger btn-xs waves-effect waves-light mr-2 float-right" id="importSelect">
                                    <option value=""> কুরিয়ার এন্ট্রি  </option>
...
@push('js')
    ...
    defaultDate: new Date(),   // Optional: set default date to now
        ...
        $(".courierID").select2({
            ...
            $(document).on('change', '#importSelect', function (e) {
                ...
                window.location.href = "{{url('manager/order/import')}}?type=" + exportType + "&ids=" + ids.join(',');
            });
    ...
    defaultDate: new Date(),   // Optional: set default date to now
            ...
            $(document).on('change', '#exportSelect', function (e) {
                ...
                // Send the request to the server to export data
                window.location.href = "{{url('manager/order/export')}}?type=" + exportType + "&ids=" + ids.join(',');
            });
