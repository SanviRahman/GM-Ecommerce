        ...
        $(document).ready(function() {
            ...
            $(document).on("click", ".btn-delete", function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        console.log("{{ url('manager/size') }}"+id);
                        $.ajax({
                            url: "{{ url('manager/size') }}/" + id,
                            type: 'DELETE',
                            data: {
