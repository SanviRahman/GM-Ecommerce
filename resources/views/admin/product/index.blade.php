    ...
    <script>
        $(document).ready(function(){
            ...
            $("#productSize").select2({
                ...
                ajax: {
                    type: "post",
                    url: '{{url('admin/product/size')}}', // Update this URL as needed
                    data: {
                        '_token': token
                    },
                    processResults: function (data) {
            ...
            $("#productColor").select2({
                ...
                ajax: {
                    type: "post",
                    url: '{{url('admin/product/color')}}', // Update this URL as needed
                    data: {
                        '_token': token
                    },
                    processResults: function (data) {
            ...
            //                     '<img src="{{ asset("/public/product/thumbnail/") }}/' + media.url + '">' +
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#producOption").select2({
                            ...
                            ajax: {
                                type: "post",
                                url: '{{url('admin/product/option')}}', // Update this URL if necessary
                                data: {
                                    '_token': token
                                },
                                processResults: function (data) {
                        ...
                        $("#productSize").select2({
                            ...
                            ajax: {
                                type: "post",
                                url: '{{url('admin/product/size')}}', // Update this URL if necessary
                                data: {
                                    '_token': token
                                },
                                processResults: function (data) {
                        ...
                        $("#productColor").select2({
                            ...
                            ajax: {
                                type: "post",
                                url: '{{url('admin/product/color')}}', // Update this URL if necessary
                                data: {
                                    '_token': token
                                },
                                processResults: function (data) {
