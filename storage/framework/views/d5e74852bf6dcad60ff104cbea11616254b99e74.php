    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var table = $("#table").DataTable({
                ajax: "<?php echo e(url('admin/media/create')); ?>",
                pageLength: 50,
                ordering: false,
                columnDefs: [
                    {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\public_html\resources\views/admin/media/index.blade.php ENDPATH**/ ?>