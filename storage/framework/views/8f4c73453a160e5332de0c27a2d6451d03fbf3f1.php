                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="inputGroupPrepend"><?php echo e(url('/product/')); ?>/</span>
                            ...
                            <div class="form-group mb-3">
                                <label for="isFreeDelivery">Is Free Delivery? <span class="text-danger">*</span></label>
                                <select id="isFreeDelivery" class="form-control">
                            ...
                            <div class="form-group mb-3">
                                <label for="isStockOut">Stock Out <span class="text-danger">*</span></label>
                                <select id="isStockOut" class="form-control">
                                    <option value="">-- Select --</option>
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" id="productSize" data-toggle="select2" multiple="multiple" data-placeholder="Choose ...">
                                    <option>Select</option>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" id="productColor" data-toggle="select2" multiple="multiple" data-placeholder="Choose ...">
                                    <option>Select</option>
                                </select>
                            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            var table = $("#table").DataTable({
                ...
                ajax: "<?php echo e(url('admin/product/show')); ?>",
                pageLength: 50,
                ordering: false,
                columnDefs: [
                    {
            ...
            $("#productCategory").select2({
                ...
                ajax: {
                    type: "post",
                    url:'<?php echo e(url('admin/product/category')); ?>',
                    data: {
                        '_token': token
                    },
            ...
            // Initialize Select2 for Product Size
            $("#productSize").select2({
                placeholder: "Select Size",
                multiple: true,
                ajax: {
                    type: "post",
                    url: '<?php echo e(url('admin/product/size')); ?>', // Update this URL as needed
                    data: {
                        '_token': token
                    },
                    processResults: function (data) {
            ...
            // Initialize Select2 for Product Color
            $("#productColor").select2({
                placeholder: "Select Color",
                multiple: true,
                ajax: {
                    type: "post",
                    url: '<?php echo e(url('admin/product/color')); ?>', // Update this URL as needed
                    data: {
                        '_token': token
                    },
                    processResults: function (data) {
            ...
            //     $.ajax({
            //         url: "<?php echo e(url('admin/product/')); ?>/" + id + "/edit",
            //         headers: {
            //             'X-CSRF-TOKEN': token
            //         },
            ...
            //             var html = ('<div class="image-holder image-"><img src="<?php echo e(asset('/public/product/thumbnail/')); ?>/' +data['productImage']+ '"><button type="button" class="btn btn-danger btn-xs waves-effect waves-light remove-image float-right"><i class="mdi mdi-close"></i></button><input type="hidden" name="imageID" value="' + data['productImage'] + '"></div>');
            ...
            //                     '<img src="<?php echo e(asset("/public/product/thumbnail/")); ?>/' + media.url + '">' +
            //                     '<button type="button" class="btn btn-danger btn-xs waves-effect waves-light remove-image float-right">' +
            //                     '<i class="mdi mdi-close"></i></button>' +
            //                     '<input type="hidden" name="imageID[]" value="' + media.url + '">' +
            //                     '</div>'
            //                 );
            //             });
            //             $('.image-list').find(".image-holder.placeholder").remove(); // Remove any placeholder if present
            //             $('.image-list').empty().append(galleryHtml);
            ...
            $(document).on("click", ".btn-edit", function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#productSlug').val(data['productSlug']);
                        $('#productCode').val(data['productCode']);
                        $('#isFreeDelivery').val(data['isFreeDelivery']);
                        $('#isStockOut').val(data['isStockOut']);
                        $("#productDetails").summernote("code", data['productDetails']);
                        ...
                        // Initialize Select2 for Product Category
                        $("#productCategory").select2({
                            placeholder: "Select a Category",
                            multiple: true,
                            ajax: {
                        ...
                        // Populate product Option
                        $("#producOption").empty();
                        $.each(data['options'], function (key, value) {
                            $("#producOption").append('<option value="' + value.id + '" selected>' + value.optionName + '</option>');
                        });
            
                        // Initialize Select2 for Product Option
                        $("#producOption").select2({
                            placeholder: "Select Option",
                            multiple: true,
                            ajax: {
                                type: "post",
                                url: '<?php echo e(url('admin/product/option')); ?>', // Update this URL if necessary
                                data: {
                                    '_token': token
                                },
                                processResults: function (data) {
                        ...
                        $.each(data['sizes'], function (key, value) {
                            $("#productSize").append('<option value="' + value.id + '" selected>' + value.sizeName + '</option>');
                        });
                        ...
                        $("#productSize").select2({
                            ...
                            ajax: {
                                type: "post",
                                url: '<?php echo e(url('admin/product/size')); ?>', // Update this URL if necessary
                                data: {
                                    '_token': token
                                },
                                processResults: function (data) {
                        ...
                        $.each(data['colors'], function (key, value) {
                            $("#productColor").append('<option value="' + value.id + '" selected>' + value.colorName + '</option>');
                        });
                        ...
                        $("#productColor").select2({
                            ...
                            ajax: {
                                type: "post",
                                url: '<?php echo e(url('admin/product/color')); ?>', // Update this URL if necessary
                                data: {
                                    '_token': token
                                },
                                processResults: function (data) {
                ...
                if (type === 'Save') {
                    $.ajax({
                        ...
                        data: {
                            ...
                            'isFreeDelivery': isFreeDelivery.val(),
                            'isStockOut': isStockOut.val(),
            ...
            $(document).on('click', '.btn-status', function () {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(url('admin/product/status')); ?>",
                    data: {
                        'status': status,
                        'id': id,
                        '_token': token
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\public_html\resources\views/admin/product/index.blade.php ENDPATH**/ ?>