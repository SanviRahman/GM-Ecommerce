    ...
    <script>
        ...
        $(document).ready(function(){
            var table = $("#stockTable").DataTable({
                ajax: "<?php echo e(url('admin/user/users')); ?>",
                "pageLength": 50,
                ordering: false,
                columns: [
                    {data: "id"},
                    {
                        ...
                        render: function (data) {
                             return '<a href="<?php echo e(url("admin/user/login/")); ?>/' + data.id + '">' + data.name + '</button>';
                        }
                    }, 
                    {data: "phone"},
                    {data: "email"},
            ...
            $(document).on("click", ".btn-edit", function (e) {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/user/')); ?>/" + id + "/edit",
                    headers: {
                        'X-CSRF-TOKEN': token
                    },
            ...
            $(document).on("click", ".btn-submit", function () {
                ...
                if (type === 'Update') {
                    $.ajax({
                        type: "PUT",
                        url: "<?php echo e(url('admin/user')); ?>/" + userID,
                        data: {
                            'name': name.val(),
                            'phone': phone.val(),
                            'email': email.val(),
            ...
            $("#roleID").select2({
                ...
                ajax: {
                    url:'<?php echo e(url('admin/user/role')); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\public_html\resources\views/admin/user/index.blade.php ENDPATH**/ ?>