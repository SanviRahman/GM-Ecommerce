    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $("#table").DataTable({
                ajax: "<?php echo e(url('admin/option/create')); ?>",
                pageLength: 50,
                ordering: false,
                columns: [
                    { data: "id" },
            ...
            $(document).on("click", ".btn-edit", function() {
                ...
                $.ajax({
                    url: "<?php echo e(url('admin/option')); ?>/" + id + "/edit",
                    headers: {
                        'X-CSRF-TOKEN': token
                    },
            ...
            $(document).on("click", "#submit", function() {
                ...
                if (type === 'Save') {
                    ...
                    $.ajax({
                        type: "post",
                        url: "<?php echo e(url('admin/option')); ?>",
                        data: {
                    ...
                    $.ajax({
                        type: "PUT",
                        url: "<?php echo e(url('admin/option')); ?>/" + id,
                        data: {
                            'optionName': optionName,
                            '_token': token
                        },
            ...
            $(document).on('click', '.btn-status', function() {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(url('admin/option/status')); ?>",
                    data: {
                        'status': status,
                        'id': id,
                        '_token': token
            ...
            $(document).on("click", ".btn-delete", function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        console.log("<?php echo e(url('admin/option')); ?>"+id);
                        $.ajax({
                            url: "<?php echo e(url('admin/option')); ?>/" + id,
                            type: 'DELETE',
                            data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\public_html\resources\views/admin/option/index.blade.php ENDPATH**/ ?>