    ...
    <script>
         ...
         $(document).ready(function(){
             var table = $("#storeTable").DataTable({
                 ajax: "<?php echo e(url('admin/store/show')); ?>",
                 "pageLength": 50,
                 ordering: false,
                 columns: [
                     {data: "id"},
             ...
             $(document).on("click", ".btn-edit", function () {
                 var id = $(this).val();
                 $.ajax({
                     url: "<?php echo e(url('admin/store/')); ?>/" + id + "/edit",
                     headers: {
                         'X-CSRF-TOKEN': token
                     },
             ...
             $(document).on("click", "#submit", function () {
                 ...
                 if (type === 'Save') {
                     $.ajax({
                         type: "post",
                         url: "<?php echo e(url('admin/store')); ?>",
                         data: {
                 ...
                 if (type === 'Update') {
                     $.ajax({
                         type: "PUT",
                         url: "<?php echo e(url('admin/store')); ?>/" + storeID,
                         data: {
                             'storeName': storeName.val(),
                             'storeUrl': storeUrl.val(),
                             'storeDetails': storeDetails.val(),
                 ...
                 Swal.fire({
                     ...
                     if(t.value){
                         $.ajax({
                             ...
                             type: "DELETE",
                             url: "<?php echo e(url('admin/store/')); ?>/" + id,
                             data: {
                                 '_token': token
                             },
                             contentType: "application/json",
             ...
             $(document).on('click', '.btn-status', function () {
                 ...
                 $.ajax({
                     type: "post",
                     url: "<?php echo e(url('admin/store/status')); ?>",
                     data: {
                         'status': status,
                         'id': id,
                         '_token': token
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\public_html\resources\views/admin/store/index.blade.php ENDPATH**/ ?>