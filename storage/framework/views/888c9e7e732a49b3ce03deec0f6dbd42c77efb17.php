																...
																<div>
																	<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<div class="custom-control custom-checkbox">
																			<input type="checkbox" class="custom-control-input" name="category" value="<?php echo e($category->categoryName); ?>" data-link="<?php echo e(url('category/'.$category->categorySlug)); ?>"  id="customCheck<?php echo e($category->id); ?>">
																			<label class="custom-control-label" for="customCheck<?php echo e($category->id); ?>"><?php echo e($category->categoryName); ?></label>
																		</div>
																	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																	<br>
																</div>
															...
															<div class="customlinkdiv" id="customlinkdiv">
																<div>
																	<?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<div class="custom-control custom-checkbox">
																			<input type="checkbox" class="custom-control-input" name="page" value="<?php echo e($page->pageTitle); ?>" data-link="<?php echo e(url('page/'.$page->pageSlug)); ?>"  id="page<?php echo e($page->id); ?>">
																			<label class="custom-control-label" for="page<?php echo e($page->id); ?>"><?php echo e($page->pageTitle); ?></label>
																		</div>
																	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																	<br>
																</div>
...
<?php /**PATH D:\public_html\resources\views/vendor/wmenu/menu-html.blade.php ENDPATH**/ ?>