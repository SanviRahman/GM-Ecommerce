...
<head>
    ...
    <script>
        ...
        var campaignTrackingItems = <?php echo json_encode($campaignTrackingItems, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
        var campaignCheckoutProducts = <?php echo json_encode($campaignCheckoutProducts, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
        var campaignTrackingValue = <?php echo e($campaignTrackingValue); ?>;
        var campaignName = <?php echo json_encode($campaign_data->name ?: $campaign_data->banner_title, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
        var campaignSlug = <?php echo json_encode($campaign_data->slug, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;

        // Campaign-specific page event.
        window.dataLayer.push({
            event: 'view_campaign',
            pageType: 'campaign',
            campaignId: <?php echo e((int) $campaign_data->id); ?>,
        ...
        window.dataLayer.push({
            ...
            campaign: {
                id: <?php echo e((int) $campaign_data->id); ?>,
                name: campaignName,
                slug: campaignSlug
            }
        });
    ...
    <div class="container py-3 py-md-5">
        ...
        <div class="row gy-2 justify-content-between align-items-center">
            <div class="col-md-6 text-start">
                <h2 class=" py-2 py-md-4 fw-bolder" style="color:#FDDF31"><?php echo $campaign_data->banner_title; ?> </h2>
                <h5 class="text-light fs-4 font-weight-normal"><?php echo $campaign_data->short_description; ?></h5>
                <h4 class="text-light mt-3 text-center">
                    রেগুলার মূল্য <span class="price-regular"> ৳ <?php echo e($product->productRegularPrice); ?> টাকা </span>
                </h4>
                <h4 class="text-light mt-3 text-center">
                    অফার মূল্য <span class="price-sale price-sale-animated"> ৳ <?php echo e($product->productSalePrice); ?> টাকা </span>
                </h4>
             ...
             <div class="col-md-6">
                <img class="img-fluid shadow border rounded" src="<?php echo e(asset('public/campaigns/'.$campaign_data->banner)); ?>" >
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <h2 class="text-center p-2 p-md-4 rounded" style="background-color:#FBEFF7; border:2px dashed #F1ACE7;">
                    <?php if($campaignPhone): ?>
                        আমাদের থেকে বিস্তারিত জানতে এই
                        <a href="tel:<?php echo e($campaignPhone); ?>" style="color:#d63384; font-weight: bold; text-decoration: underline;">
                            <?php echo e($campaignPhone); ?>
                ...
                <div class="row justify-content-center my-2 my-md-4 gy-2">
                    ...
                    <div class="col-md-6 custom_btn">
                        <div class="shadow-lg">
                            <a href="tel:<?php echo e($campaignPhone); ?>"
                    ...
                    <?php if($campaignWhatsappLink): ?>
                    <div class="col-md-6">
                        <div class="shadow-lg">
                            <a href="https://wa.me/<?php echo e($campaignWhatsappLink); ?>"
...
<?php if(optional($campaign_data)->description && strlen($campaign_data->description) > 15): ?>
            ...
            <div class="col-sm-12">
                <div class="campro_inn">
                    <div class="campro_head">
                        <h2 class="text-center mb-3"><?php echo e($product->productName); ?></h2>
                    </div>
                    ...
                    <div class="campro_img_slider owl-carousel">
                       ...
                       <div class="campro_img_item" style="border:5px solid red;" class="rounded">
                           <img  class="rounded" src="<?php echo e(asset('public/campaigns/'.$campaign_data->image_one)); ?>" alt="">
                       </div> 
                       <?php endif; ?>
                        <?php if($campaign_data->image_two): ?>
                       <div class="campro_img_item" style="border:5px solid red;" class="rounded">
                           <img  class="rounded" src="<?php echo e(asset('public/campaigns/'.$campaign_data->image_two)); ?>" alt="">
                       </div> 
                       <?php endif; ?>
                        <?php if($campaign_data->image_three): ?>
                       <div class="campro_img_item" style="border:5px solid red;" class="rounded">
                           <img  src="<?php echo e(asset('public/campaigns/'.$campaign_data->image_three)); ?>" alt="">
                       </div>
                       <?php endif; ?>
                    </div>
                    <div style="text-align: center; margin: 40px 0;">
                    ...
                    <article class="card-body">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    ?>
                                    <?php if($shipingCharges->isNotEmpty()): ?>
                                        <div class="shipping-options">
                                            <?php $__currentLoopData = $shipingCharges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $shipingCharge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <label class="shipping-option <?php echo e($index === 0 ? 'active' : ''); ?>">
                                                    <input
                                                        type="radio"
                                                        name="area"
                                                        id="area-<?php echo e($shipingCharge->id); ?>"
                                                        value="<?php echo e($shipingCharge->charge); ?>"
                                                        <?php echo e($index === 0 ? 'checked' : ''); ?>

                                                        required
                                                    >
                                                    <?php echo e($shipingCharge->name); ?>
            ...
            <div class="col-md-6 order-1 order-md-2 mb-4 mb-md-0">
                <div class="campaign-product-picker">
                    ...
                    <div class="campaign-product-options">
                        <?php $__currentLoopData = $campaignProducts->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaignProductIndex => $campaignProductItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <label class="campaign-product-choice <?php echo e($campaignProductSelected ? 'active' : ''); ?>" data-product-id="<?php echo e($campaignProductItem->id); ?>">
                                <input
                                    type="checkbox"
                                    class="campaign-product-checkbox"
                                    value="<?php echo e($campaignProductItem->id); ?>"
                                    <?php echo e($campaignProductSelected ? 'checked' : ''); ?>
                                ...
                                <span class="campaign-product-meta">
                                    <span class="campaign-product-name"><?php echo e($campaignProductItem->productName); ?></span>
                                    <span class="campaign-product-price">TK <?php echo e(number_format((float) $campaignProductPrice, 0, '.', '')); ?></span>
                                </span>
                                <span class="campaign-product-state"><?php echo e($campaignProductSelected ? 'Selected' : 'Select'); ?></span>
                            </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                <div class="orderDetails">
                    <?php echo $__env->make('website.partials.campaign_order_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
...
<script>
    ...
    function pushCampaignCheckoutTracking(updateSource) {
        ...
        // Push the complete current cart state directly.
        // Do not push { ecommerce: null } here because DataLayer Checker
        // displays that reset as a separate generic `data` event.
        // Every begin_checkout event below contains the full, latest cart,
        // so previous campaign cart values are overwritten by the new event.
        window.dataLayer.push({
            event: 'begin_checkout',
            value: state.value,
            currency: 'BDT',
        ...
        // Keep an explicit cart-update event for debugging/GTM rules without
        // relying only on repeated begin_checkout events.
        window.dataLayer.push({
            event: 'campaign_cart_update',
            value: state.value,
            currency: 'BDT',
            items: state.items,
            campaign_id: <?php echo e((int) $campaign_data->id); ?>,
            campaign_slug: campaignSlug,
            update_source: updateSource || 'campaign_cart_update'
        });
    }

    function refreshCampaignOrderDetails(html, updateSource) {
    ...
    function toggleCampaignProduct(element) {
        ...
        $.post("<?php echo e(route('campaign.cart.product')); ?>", {
            _token: '<?php echo e(csrf_token()); ?>',
            campaign_id: <?php echo e((int) $campaign_data->id); ?>,
    ...
    function updateQuantity(key, element){
        ...
        $.get("<?php echo e(route('campaign.cart.quantity')); ?>", {
            _token: '<?php echo e(csrf_token()); ?>',
            key: key,
            quantity: quantity
        }, function(data){
            refreshCampaignOrderDetails(data, 'quantity_change');
        });
    }

    function updateCampaignOption(key, optionId) {
        $.get("<?php echo e(route('campaign.cart.option')); ?>", {
            _token: '<?php echo e(csrf_token()); ?>',
            key: key,
            option_id: optionId
        }, function(data) {
    ...
    function updateCampaignColor(key, colorId) {
        $.post("<?php echo e(route('campaign.cart.color')); ?>", {
            _token: '<?php echo e(csrf_token()); ?>',
            key: key,
            color_id: colorId
        }, function(data) {
...
<script>
        $(document).ready(function () {
            ...
            $('input[name="area"]').on('change', function () {
                ...
                $.ajax({
                    type: "get",
                    url: "<?php echo e(url('/updateDeliveryCharge')); ?>",
                    data: {
...
function saveInput() {
    ...
    fetch("<?php echo e(url('/save-input')); ?>", {
        method: 'POST',
        headers: {
...
<?php /**PATH D:\public_html\resources\views/website/campaign.blade.php ENDPATH**/ ?>