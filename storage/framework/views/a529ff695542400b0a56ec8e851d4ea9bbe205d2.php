...
<script>
    ...
    $(document).ready(function(){
        ...
        var table = $("#table").DataTable({
            ajax: "<?php echo e(url('admin/media/iframeget?multiple=')); ?><?php echo e($multiple); ?>",
            pageLength: 50,
            ordering: false,
            columnDefs: [
                {
        ...
        $("form.dropzone").dropzone({
            addRemoveLinks: true,
            acceptedFiles: "image/*",
            url: "<?php echo e(url('admin/media')); ?>",
            ...
            Swal.fire({
                ...
                if(t.value){
                    $.ajax({
                        ...
                        type: "DELETE",
                        url: "<?php echo e(url('admin/media/')); ?>/" + id,
                        data: {
                            '_token': token
                        },
            ...
            if(ids.length > 0) {
                Swal.fire({
                    ...
                    if (t.value) {
                        $.ajax({
                            type: "get",
                            url: "<?php echo e(url('admin/media/delete')); ?>",
                            data: {
                                'ids': ids
                            },
                            contentType: "application/json",
        ...
        $(document).on("click", ".btn-edit", function () {
            var id = $(this).attr('data-id');
            $.ajax({
                url: "<?php echo e(url('admin/media')); ?>/" + id + "/edit",
                headers: {
                    'X-CSRF-TOKEN': token
                },
                contentType: 'application/json',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\public_html\resources\views/admin/media/iframe.blade.php ENDPATH**/ ?>