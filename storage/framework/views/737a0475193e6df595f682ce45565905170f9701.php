                    ...
                    <?php $__currentLoopData = $campaignCartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="cart-item">
                            <td class="product-image" style="display: flex; flex-direction: row-reverse;">
                                ...
                                <button type="button" onclick="removeFromCart('<?php echo e($item->rowId); ?>')" class="btn btn-danger btn-sm">
                                    <i class="fa fa-trash"></i>
                                </button>
                            </td>

                            <td class="product-name">
                                <span class="d-block"><?php echo e($item->model->productName); ?></span>
    ...
    <article class="card-body border-top">
        <dl class="row">
            ...
            <dd class="col-sm-4 text-right">
                <strong class="h5 text-dark">TK <?php echo e(number_format((float) Cart::subtotal('0', '', '') + $campaignDeliveryCharge, 0, '.', '')); ?></strong>
            </dd>
        </dl>
    </article>
